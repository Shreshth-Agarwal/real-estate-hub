...
import { Search, Filter, MapPin, Package, Home, LayoutDashboard } from "lucide-react";
...
export default function CatalogsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b sticky top-0 bg-background/95 backdrop-blur-lg z-50">
